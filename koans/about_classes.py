...
class AboutClasses(Koan):
    ...
    class Dog6:
        ...
        def __str__(self):
            return f'This is a dog named {self._name}.'
    ...
    def test_str_provides_a_string_version_of_the_object(self):
        ...
        self.assertEqual("This is a dog named Fido.", str(fido))

    def test_str_is_used_explicitly_in_string_interpolation(self):
        fido = self.Dog6("Fido")

        self.assertEqual('My dog is This is a dog named Fido.', "My dog is " + str(fido))
